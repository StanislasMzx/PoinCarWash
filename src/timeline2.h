 ...
 *
 * @var Timeline_station::stationId
 * ID of the station
...
Station_state_t *get_station_state_by_tick(int one_tick, char *one_id, Timeline_t *one_timeline);

void update_timeline_by_tick(Timeline_t *one_time_line, int tick);
